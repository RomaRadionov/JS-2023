console.log('-------------Task1-additional-3: Цикли-------------')
// 1. Створити пустий масив та :
console.log('-------------Task1-additional-3: a. заповнити його 50 парними числами за допомоги циклу-------------')
...
// EXAMPLE: [ 1, 2, 3, 5, 7, 9, 56, 8, 67 ] -> Має бути виведено 1, 9, 56
    console.log('-------------Task6-additional-3: Цикли-------------')
...
console.log(middleBill / price.length)
